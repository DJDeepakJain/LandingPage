      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-8 md:py-10 lg:py-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-6 md:pb-8">
            <h3 className="text-xl md:text-2xl font-extrabold leading-tighter mb-1">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-teal-500 to-blue-800">
                OfferGhosting
              </span> This refers to when candidates accept job offers but vanish without a trace.
            </h3>
            <p className="text-base text-gray-600">
              Leaving companies in a lurch. In the US, companies spend an average of 35 working days and $3500 to hire a candidate, while in India, the costs stand at about 30,000 Rs. The impact of candidate ghosting is significant, affecting businesses' functioning, finances, and future plans.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto mt-8 md:mt-12">
            <div className="relative bg-white border border-gray-200 rounded p-4">
              ...
              <div className="text-center md:text-left">
                <svg className="w-16 h-16 fill-current text-blue-500 md:absolute md:-mt-3 md:-mr-8 right-0 top-0" viewBox="0 0 64 64" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
                ...
                <cite className="block font-semibold md:font-bold text-base md:text-lg not-italic mb-1">
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-yellow-400">OFFER GHOSTING PLATFORM.</span>
                </cite>
              </div>
