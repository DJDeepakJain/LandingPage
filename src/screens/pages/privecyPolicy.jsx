...
import '../../css/Terms.css'; // Import the CSS file containing the styles
            ...
            <div className="content-section">
                ...
                <nav className="toc-container">
                    <ul className="toc">
                        ...
                        <li><a href="#property">Intellectual Propertyd</a></li>
                        <li><a href="#support">Support and Updates</a></li>
                        <li><a href="#warranty">Warranty Disclaimer and Limitation of Liability</a></li>
                        <li><a href="#indemnification">Indemnification</a></li>
                        <li><a href="#modification">Modifications to the Agreement</a></li>
                ...
                <div id="introduction">
                    ...
                    <p className="far-star">PLEASE READ THIS END USER LICENSE AGREEMENT CAREFULLY.
                ...
                <div id="license">
                    ...
                    <p className="far-star">1.1 Grant of License: Subject to the terms and conditions of this Agreement, the
                        ...
                        <span>1.2 Use of Trust Scores<br></br>
                        ...
                        <span>1.3 Restrictions: For example purposes, and without limiting LICENSOR’s rights to
                ...
                <div id="property">
                    ...
                    <p className="far-star">W2.1 Ownership: The Licensor retains all rights, title, and interest, including all
                ...
                <div id="support">
                    ...
                    <p className="far-star">3.1 Support: The Licensor may provide support services related to the Software at its
                        discretion.<br></br>
                        <span>3.2 Updates: The Licensor may release updates, bug fixes, or new versions of the
                ...
                <div id="warranty">
                    ...
                    <p className="far-star">4.1 Warranty: YOU EXPRESSLY ACKNOWLEDGE THAT USE OF THE
                        ...
                        WITH ITS USE.<br></br>
                        <span>4.2 Limitation of Liability:<br></br>
                ...
                <div id="indemnification">
                    ...
                    <p className="far-star">5.1 The Licensee/User agrees to indemnify, defend, and hold the Licensor harmless
                ...
                <div id="modification">
                    ...
                    <p className="far-star">6.1 The Licensor reserves the right to modify or update this Agreement at any time.
                ...
                <div id="termination">
                    ...
                    <p className="far-star">7.1 Termination: This Agreement is effective from the earlier of the date You
                        ...
                        <span>7.2 Effect of Termination: Upon termination, the User shall cease all use of the
                            Software.</span></p>
                </div>
                <div id="general">
                    <h2><i></i> 8. General</h2>
                    <p className="far-star">8.1 Severability: If any provision of this Agreement is found to be invalid, illegal, or
                        unenforceable, the remaining provisions shall continue in full force and effect.<br></br>
                        <span>8.2 Entire Agreement: This Agreement constitutes the entire agreement between the
                        ...
                        <span>8.3 Governing Law and Jurisdiction: This Agreement shall be governed by and
                        ...
                        <span>8.4 Modifications to the EULA:
                            ...
                            Platform.</span><br></br>
                        <span>8.5 Contact Information:<br></br>
