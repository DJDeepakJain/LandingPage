                ...
                <div className="content-section">
                    ...
                    <nav className="toc-container">
                        <ul className="toc">
                            ...
                            <li><a href="#license">1. License Grant</a></li>
                            <li><a href="#property">2. Intellectual Propertyd</a></li>
                            <li><a href="#support">3. Support and Updates</a></li>
                            <li><a href="#warranty">4. Warranty Disclaimer and Limitation of Liability</a></li>
                            <li><a href="#indemnification">5. Indemnification</a></li>
                            <li><a href="#modification">6. Modifications to the Agreement</a></li>
                            <li><a href="#termination">7. Termination</a></li>
                            <li><a href="#general">8. General</a></li>
                        </ul>
                    </nav>
