                ...
                <div className="content-section">
                    ...
                    <nav className="toc-container">
                        <ul className="toc">
                            ...
                            <li><a href="#definitions">Article 1: Definitions</a></li>
                            <li><a href="#dol">Article 2: Development, Ownership, and Licensing of API</a></li>
                            <li><a href="#aur">Article 3: API usage and Restrictions</a></li>
                            <li><a href="#fee">Article 4: Fees and Payment</a></li>
                            <li><a href="#lip">Article 5: License and Intellectual Property</a></li>
                            <li><a href="#upo">Article 6: Users and Providers Obligations</a></li>
                            <li><a href="#confidentiality">Article 7: Confidentiality</a></li>
                            <li><a href="#indemnification">Article 8: Indemnification</a></li>
                            <li><a href="#etr">Article 9: Effective Date, Term and Termination, Refund Policy</a></li>
                            <li><a href="#general">Article 10: General</a></li>
                        </ul>
                    </nav>

                    <div id="recitals">
                        <h2><i></i> Recitals:</h2>
                        <p className="far-star"><strong>WHEREAS,</strong> the Provider is a Company that offers a block-chain based
                            ...
                            <span><strong>WHEREAS,</strong> the Provider and the User desire to set forth herein their
                            ...
                            <span><strong>WHEREAS,</strong> by entering this Agreement, the Parties shall ensure that their
                            ...
                            <span><strong>NOW, THEREFORE,</strong> in consideration of the foregoing recitals, the mutual
                            ...
                            <span>The parties have agreed to enter into this Agreement on such terms and
                                conditions as are set out herein and in the Annexure(s) to this Agreement.</span><br></br>
                            <span>All Annexures to this Agreement shall be an integral part of this Agreement
                    ...
                    <div id="definitions">
                        ...
                        <p className="far-star">1.1 &quot;API&quot; refers to the application-programming interface provided by the
                            Provider, allowing the User to access and utilize certain services or data.<br></br>
                            <span>1.2 &quot;API Documentation&quot; means the technical documentation provided by the
                            ...
                            <span>1.3 “Applicable Laws” means all laws and regulations, including any
                            ...
                            <span>1.4 “API Information” means all candidates data, trust score generated by
                            ...
                            <span>1.5 &quot;PII&quot; stands for personally identifiable information. It refers to any
                            ...
                            <span>1.6 “Confidential Information” includes the following:
                            ...
                            <span>1.7 “Intellectual Property Rights” means patent rights, copyrights, database
                    ...
                    <div id="dol">
                        ...
                        <p className="far-star">2.1. Development. The Provider has developed the API and the
                            specifications for the API to be used by the User pursuant to this Agreement
                            are provided in Annexure A hereto.<br></br>
                            <span>2.2.Ownership of API. The Provider shall exclusively own all rights, title, and
                            ...
                            <span>2.3. License Grant. Subject to the terms and conditions of this Agreement, the
                            ...
                            <span>2.4.API Documentation. The Provider shall provide the User with access to
                    ...
                    <div id="aur">
                        ...
                        <p className="far-star"><strong>3. API Usage and Restrictions</strong><br></br>
                            <span>3.1 Usage. The User agrees to use the API in compliance with this Agreement
                            ...
                            <span>3.2 Restrictions. The User shall not, directly or indirectly:<br></br>
                    ...
                    <div id="fee">
                        ...
                        <p className="far-star">4.1 Fees:<br></br> The Parties shall agree upon the fees for the API services
                            separately, including any applicable usage limits, pricing tiers, or additional
                            charges.<br></br>
                            <span>4.2 Payment Terms:<br></br> The User shall pay the fees to the Provider according to
                    ...
                    <div id="lip">
                        ...
                        <p className="far-star">5.1 License to Use API.  <br></br>
                            ...
                            <span>5.2 Intellectual Property.<br></br>
                    ...
                    <div id="upo">
                        ...
                        <p className="far-star">6.1 Users Obligations.<br></br>
                            ...
                            <span>Provider's Obligation<br></br>
                    ...
                    <div id="confidentiality">
                        ...
                        <p className="far-star">7.1 Confidentiality.<br></br>
                            ...
                            <span>7.2 For purposes of the Agreement:<br></br>
                    ...
                    <div id="indemnification">
                        ...
                        <p className="far-star">8.1 By the User Company. The User shall defend, indemnify, and hold the
                            ...
                            <span>8.2 By the Provider Company. The Provider shall defend, indemnify, and
                            ...
                            <span>8.3 Indemnity Conditions. A Party’s obligation to indemnify as provided in this
                    ...
                    <div id="etr">
                        ...
                        <p className="far-star">9.1 Term. This Agreement shall commence on the Effective Date and shall
                            ...
                            <span>9.2 Termination for Material Breach. Either party may terminate this
                                ...
                                breach.</span><br></br>
                            <span>9.3 Termination for Cause. This Agreement may further be terminated for
                            ...
                            <span>9.4 Termination due to Change in Control. (i) Either Party may terminate
                            ...
                            <span>9.5 Effects of Termination.<br></br>
                    ...
                    <div id="general">
                        ...
                        <p className="far-star">10.1 Notice. Any notice, approval, authorization, consent, or other
                            ...
                            <br></br>
                            <br></br>
                            <span>10.2 Force Majeure. Force Majeure shall not give rise to any claim against
                            ...
                            <span>10.3 Governing Law, Arbitration and Jurisdiction of Courts.<br></br>
                            ...
                            <span>10.4 Assignment. Neither Party may assign or transfer this Agreement or
                            ...
                            <span>10.5 Waiver. Unless otherwise expressly stated in this Agreement, the
                            ...
                            <span>10.6 Severability. If any provision of this Agreement is or becomes, in whole
                            ...
                            <span>10.7 Independent Contractors. This Agreement shall be on a Principal-to-
                            ...
                            <span>10.8 Counterparts. This Agreement may be executed in several
                            ...
                            <span>10.9 English Language. This Agreement has been prepared in the English
                            ...
                            <span>10.10 Entire Agreement. This Agreement, including Addendum, constitutes
                            ...
                            <span>10.11 Conduct. By entering into this Agreement, both the Parties shall
                            ...
                            <span>10.12 Headings. The headings appearing herein are inserted only as a
                            ...
                            <span>10.13 Amendments. This Agreement shall not be varied, amended or
                            ...
                            <span>10.14 Acknowledgements. Each party acknowledges that he or she had an
