...
export default function Features() {
  ...
  return (
    <section className="relative">
      ...
      <div className="absolute left-0 right-0 m-auto w-px p-px h-80 bg-gray-200 transform -translate-y-1/2"></div>

      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          {/* Section header */}
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
          <h3 className="text-2xl md:text-4xl font-extrabold leading-tighter  mb-2">Explore the features</h3>
            <cite className="text-xl text-gray-600">
