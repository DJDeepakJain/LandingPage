        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <h6 className="text-gray-800 font-medium mb-2">Resources</h6>
            <ul className="text-sm">
              ...
              <li className="mb-2">
                <a href="https://sumerudigital.com/contact/" style={{cursor:'pointer'}} className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Support Center</a>
              </li>
              <li className="mb-2">
          ...
          <h6 className="text-gray-800 font-medium mb-2">Company</h6>
            <ul className="text-sm">
              ...
              <li className="mb-2">
                <a href="https://sumerudigital.com/company/" style={{cursor:'pointer'}} className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">About us</a>
              </li>
