...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-r from-teal-500 to-teal-200 backdrop-blur-sm shadow-lg text-white p-4">
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <h6 className="text-gray-800 font-medium mb-2">Company</h6>
            <ul className="text-sm">
              <li className="text-sm text-gray-600">
                <a href="#0" target='__blank' className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Home</a>
              </li>
              <li className="text-sm text-gray-600">
