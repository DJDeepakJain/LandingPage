...
export default function Header() {
  ...
  return (
    <header className={`fixed w-full z-30 md:bg-opacity-90 transition duration-300 ease-in-out ${!top ? 'bg-gradient-to-r from-teal-500 to-blue-400" backdrop-blur-sm shadow-lg' : 'bg-gradient-to-r from-teal-500 to-blue-400" backdrop-blur-sm shadow-lg'}`}>
